...
(function ($) {
    ...
    $.extend({
        DirtyForms: {
            ...
            dirtyClass: 'changed',
            listeningClass: 'change_listen',
            ignoreClass: 'change_ignore',
        ...
        init: function () {
            ...
            return this.each(function (e) {
                ...
                if (typeof $(document).on === 'function') {
                    ...
                    $(this).on('keyup', inputSelector, onFocus);
    ...
    var bindFn = function (ev) {
        ...
        if ($(ev.target).hasClass(settings.ignoreClass) || $(ev.target).attr('href') == undefined || isDifferentTarget(ev)) {
